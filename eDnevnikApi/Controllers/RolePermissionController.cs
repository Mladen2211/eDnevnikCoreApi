...
namespace eDnevnikApi.Controllers
{
    ...
    {
        private readonly IRolePermission _service;
        private readonly IMapper _mapper;

        public RolePermissionController(IRolePermission service, IMapper mapper)
        {
            _service = service;
            _mapper = mapper;
        }
        ...
        [HttpPost("create")]
        public async Task<EDResponse> Add([FromBody] RolePermissionReq rolePermission)
        {
            EDResponse response;
            try
            {
                response = _service.Add(rolePermission);
        ...
        [HttpPut]
        public async Task<EDResponse> Update([FromBody] RolePermissionReq rolePermission)
        {
            EDResponse response;
            try
            {
                response = _service.Update(rolePermission);
