...
namespace eDnevnikApi.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(IRole service, IMapper mapper)
        {
            _service = service;
            _mapper = mapper;
        }
        ...
        [HttpPost("create")]
        public async Task<EDResponse> Add([FromBody] RoleReq role)
        {
            EDResponse response;
            try
            {
                response = _service.Add(role);
        ...
        [HttpPut]
        public async Task<EDResponse> Update([FromBody] RoleReq role)
        {
            EDResponse response;
            try
            {
                response = _service.Update(role);
