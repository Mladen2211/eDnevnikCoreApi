...
namespace eDnevnikApi.Controllers
{
    ...
    {
        private readonly IUserRole _service;
        private readonly IMapper _mapper;

        public UserRoleController(IUserRole service, IMapper mapper)
        {
            _service = service;
            _mapper = mapper;
        }
        ...
        [HttpPost("create")]
        public async Task<EDResponse> Add([FromBody] UserRoleReq userRole)
        {
            EDResponse response;
            try
            {
                response = _service.Add(userRole);
        ...
        [HttpPut]
        public async Task<EDResponse> Update([FromBody] UserRoleReq userRole)
        {
            EDResponse response;
            try
            {
                response = _service.Update(userRole);
