...
namespace eDnevnikApi.Controllers
{
    ...
    public class CityController : ControllerBase
    {
        ...
        [HttpPost("create")]
        public async Task<EDResponse> Add([FromBody] CityReq city)
        {
            EDResponse response;
            try
            {
                response = _service.Add(city);
        ...
        [HttpPut]
        public async Task<EDResponse> Update([FromBody] CityReq city)
        {
            EDResponse response;
            try
            {
                response = _service.Update(city);
